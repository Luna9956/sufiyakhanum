    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://sufiya-admin.vercel.app/products/${id}`
        );
        console.log("Fetched product:", response.data); // Log product data
        setProduct(response.data);

        const categoryResponse = await axios.get(
          `https://sufiya-admin.vercel.app/products?category=${response.data.category}`
        );
        setRelatedProducts(categoryResponse.data.slice(0, 5));
      } catch (error) {
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={5}>
            ...
            <Typography
              variant="h6"
              mt={1}
              sx={{ color: product.stock > 0 ? "#28a745" : "#dc3545" }}
            >
              {product.stock > 0
            ...
            <Box mt={2}>
              ...
              <Collapse in={openDelivery}>
                <Box mt={2}>
                  <Typography variant="body2">
                    UNSTITCHED (LOCAL): 5-7 WORKING DAYS
                  </Typography>
                  <Typography variant="body2">
                    STITCHED (LOCAL): 18-20 WORKING DAYS
                  </Typography>
                  <Typography variant="body2">
                    UNSTITCHED (INTERNATIONAL): 12-17 WORKING DAYS
                  </Typography>
                  <Typography variant="body2">
                    STITCHED (INTERNATIONAL): 22-24 WORKING DAYS
                  </Typography>
                  <Typography variant="body2">
                    All orders are dispatched around 4pm P.S.T.
                    (Monday-Saturday)
                  </Typography>
                </Box>
              </Collapse>
              ...
              <Box display="flex" mt={1}>
                <Button
                  ...
                  sx={{
                    ...
                    backgroundColor:
                      option === "unstitched" ? "#000000" : "transparent",
                    borderRadius: "4px",
                    borderWidth: "1px",
                    padding: "8px 16px",
                    marginRight: 2,
                    "&:hover": {
                      backgroundColor:
                        option === "unstitched" ? "#000000" : "#f0f0f0",
                      color: option === "unstitched" ? "#ffffff" : "#000000",
                    },
                  }}
                ...
                <Button
                  ...
                  sx={{
                    ...
                    backgroundColor:
                      option === "stitched" ? "#000000" : "transparent",
                    borderRadius: "4px",
                    borderWidth: "1px",
                    padding: "8px 16px",
                    "&:hover": {
                      backgroundColor:
                        option === "stitched" ? "#000000" : "#f0f0f0",
                      color: option === "stitched" ? "#ffffff" : "#000000",
                    },
                  }}
                  ...
                  {["XS", "S", "M", "L"].map((sizeOption) => (
                    <Button
                      ...
                      sx={{
                        ...
                        backgroundColor:
                          size === sizeOption ? "#000000" : "transparent",
                        borderRadius: "4px",
                        borderWidth: "1px",
                        padding: "8px 16px",
                        marginRight: 2,
